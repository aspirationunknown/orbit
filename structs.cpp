void Body::add_moon(const float color[3], double emissivity, double radius, double orbital_radius, double orbital_period, double rotation_period, char* texture_file)
{
    Body newBody;
    newBody.center.x = this.position.x;
    newBody.center.y = this.position.x;
    newBody.center.z = this.position.x;
